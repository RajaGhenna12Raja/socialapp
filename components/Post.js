...
async function likePost () {
  ...
  return (
    <div className='flex p-1  cursor-pointer border-b border-gray-300'>
      {/*User  image */}
    <img className='h-11 w-11 rounded-full mr-0 ml-0 p-3 items-center justify-center ' src={post.data().userImg} alt="user-img"/>
      {/* right side */}
      <div className=''>
        {/* header */}
       ...
       <ChatIcon onClick = {() => setOpen (!open)} className='h-9 w-9 hoverEffect p-2 hover:text-white hover:bg-red-600 '/>
